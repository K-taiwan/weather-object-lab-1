...
const finder = (obj) => {
    return evanstonWeather.city.name;
}
console.log(finder(evanstonWeather));
...
const round2 = (obj) => {
    return `The coordinates of ${evanstonWeather.city.name} are ${evanstonWeather.city.coord.lat} latitude and ${evanstonWeather.city.coord.lon} longitude.`;
}
console.log(round2(evanstonWeather));
